...
def main() -> None:
    ...
    print("Building multiseed_4trait_moving figure...", flush=True)
    make_fig_s51(df, outdir / "multiseed_4trait_moving.png")
    print("Building cv_4trait_moving figure...", flush=True)
    make_fig_s52(df, outdir / "cv_4trait_moving.png", args.peak_gen)
    print("Building geom_invariants_4trait_moving figure...", flush=True)
